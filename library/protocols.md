...
- Define the expected format transferred data should follow (JSON, text, bytes, etc).
...
## Questions
- How does protocols stack on top of each other?
## TL;DR
...
- Q: How does protocols stack on top of each other?